<template>
    <div>
        <button class="button is-light is-small is-light is-rounded mt-2 ml-2" aria-label="Start streaming" data-microtip-position="right" role="tooltip" v-on:click='start_session()'>Start Session</button>
